...
class TradeFactory:
    def create(self, product_type: ProductType) -> Trade:
        match product_type:
            case ProductType.BOND_FIXED:
                return self._create_bullet_bond_trade()
            case ProductType.IR_SWAP:
                return self._create_ir_swap_trade()
            case ProductType.FX_OPTION:
                return self._create_fx_option_trade()
            case ProductType.FX_SPOT:
                return self._create_fx_spot_trade()
            case _:
                raise ValueError(f"Unsupported product type: {product_type}")

    def _create_bullet_bond_trade(self) -> BulletBondTrade:
    ...
    def _create_ir_swap_trade(self) -> IRSwapTrade:
    ...
    def _create_fx_option_trade(self) -> FXOptionTrade:
    ...
    def _create_fx_spot_trade(self) -> FXTrade:
